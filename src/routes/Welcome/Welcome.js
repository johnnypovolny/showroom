...
class _Welcome extends Component {
  ...
  componentWillMount() {
    ...
    setWelcomeState('mobileOrTablet', this.mobileOrTablet());
  }
    ...
    if (mobileOrTablet) {
      return (
        <div className='route'>
          ...
          <div id='mobile-message'>The Snowroom relies on a combination of Unity and WebGL which is not currently supported on most mobile devices. We're excited to host you- please visit us from a non-mobile browser!</div>
        </div>
      );
    }
